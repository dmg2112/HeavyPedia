...
var metallica = Group(name: "Metallica", debut:Calendar.current.date(from: DateComponents(year:1982,month:3,day:14)) , members: [hetfield,ulrich,hammet,trujillo], retirement: nil, genre: .thrash
)
...
var killemall = Album(photo: "killEmAll", name: "Kill'Em All",producer:"Flemming Rassmusen",group: metallica,year:Calendar.current.date(from: DateComponents(year:1983,month:7,day:25)) )
